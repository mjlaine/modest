...
C
      INTEGER  I, NLESS1
      REAL*8  DEL1, DEL2, DMAX, DMIN, DRAT1, DRAT2, DSAVE,
...
C------------- LAST LINE OF PCHIM FOLLOWS ------------------------------
      END
      REAL*8 FUNCTION PCHST(ARG1,ARG2)
...
C------------- LAST LINE OF PCHSP FOLLOWS ------------------------------
      END
      REAL*8 FUNCTION PCHDF(K,X,S,IERR)
