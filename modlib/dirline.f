      subroutine dirline(iaux,naux,ndir,dir,x0,bounds,nevastep,
...
*     LOCAL VARIABLES
      ...
      integer*4   h                 ! number of steps before optimal point
      integer*4   i,j
...
*       optimal point and corresponding value of tt
...
*       compute points inside of "box" (and corresponding values of tt) after
*       optimal point

        do i=h+3,nevastep(iaux)+1
           tt = tl+(i-2)*deltat
           do j=1,naux
              xdir(j,i) = x0(j) + tt * dir(j)
           enddo
